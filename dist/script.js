...
/* harmony import */ var _modul_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modul/modal */ "./src/js/modul/modal.js");
/* harmony import */ var _modul_sliders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modul/sliders */ "./src/js/modul/sliders.js");
/* harmony import */ var _modul_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modul/forms */ "./src/js/modul/forms.js");
/* harmony import */ var _modul_mask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modul/mask */ "./src/js/modul/mask.js");
/* harmony import */ var _modul_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modul/checkTextInputs */ "./src/js/modul/checkTextInputs.js");
/* harmony import */ var _modul_showMoreStiles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modul/showMoreStiles */ "./src/js/modul/showMoreStiles.js");
/* harmony import */ var _modul_calc__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modul/calc */ "./src/js/modul/calc.js");
/* harmony import */ var _modul_filter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modul/filter */ "./src/js/modul/filter.js");
/* harmony import */ var _modul_accordion__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modul/accordion */ "./src/js/modul/accordion.js");
/* harmony import */ var _modul_showImg__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modul/showImg */ "./src/js/modul/showImg.js");
/* harmony import */ var _modul_burger__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modul/burger */ "./src/js/modul/burger.js");
/* harmony import */ var _modul_scrolling__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modul/scrolling */ "./src/js/modul/scrolling.js");
/* harmony import */ var _modul_drop__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modul/drop */ "./src/js/modul/drop.js");
...
document.addEventListener('DOMContentLoaded', function () {
  Object(_modul_modal__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_modul_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical');
  Object(_modul_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', '', '.main-prev-btn', '.main-next-btn');
  Object(_modul_forms__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modul_mask__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
  Object(_modul_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modul_checkTextInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
  Object(_modul_showMoreStiles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '.styles-2');
  Object(_modul_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.calc-price', '.calc .promocode', '.calc form');
  Object(_modul_filter__WEBPACK_IMPORTED_MODULE_7__["default"])('.portfolio-menu > li', '.portfolio-block', '.portfolio-no', '.portfolio-no', 'active');
  Object(_modul_accordion__WEBPACK_IMPORTED_MODULE_8__["default"])('.accordion-heading');
  Object(_modul_showImg__WEBPACK_IMPORTED_MODULE_9__["default"])();
  Object(_modul_burger__WEBPACK_IMPORTED_MODULE_10__["default"])();
  Object(_modul_scrolling__WEBPACK_IMPORTED_MODULE_11__["default"])();
  Object(_modul_drop__WEBPACK_IMPORTED_MODULE_12__["default"])();
});

/***/ }),

/***/ "./src/js/modul/accordion.js":
/*!***********************************!*\
  !*** ./src/js/modul/accordion.js ***!
  \***********************************/
...
var accordion = function accordion(triggersSelector) {
  var btns = document.querySelectorAll(triggersSelector); //  blocks = document.querySelectorAll('.accordion-block');
...
var burger = function burger() {
  var burgerElem = document.querySelector('.burger'),
      menuElem = document.querySelector('.burger-menu');
...
var calc = function calc(sizeSelect, materialSelect, optionsSelect, resultSelect, promocodeSelect, formSelect) {
  ...
  var sizeValue, materialValue, optionsValue;
  Object(_services_requests__WEBPACK_IMPORTED_MODULE_2__["getData"])('assets/db.json').then(function (res) {
    var _res$form = res.form,
        sizeValue = _res$form.size,
        materialValue = _res$form.material,
        optionsValue = _res$form.options;
    ...
    function setValueInOptions(selectElem, valueObj) {
      selectElem.children.forEach(function (option) {
...
/***/ "./src/js/modul/checkTextInputs.js":
/*!*****************************************!*\
  !*** ./src/js/modul/checkTextInputs.js ***!
  \*****************************************/
/*! exports provided: default */
...
var checkTextInputs = function checkTextInputs(select) {
...
var drop = function drop() {
  var inputs = document.querySelectorAll('[name="upload"');
  ['dragenter', 'dragleave', 'dragover', 'drop', 'drag'].forEach(function (nameEvent) {
    inputs.forEach(function (input) {
  ...
  ['dragenter', 'dragover', 'drag'].forEach(function (nameEvent) {
    inputs.forEach(function (input) {
      input.addEventListener(nameEvent, function () {
  ...
  ['dragleave', 'drop'].forEach(function (nameEvent) {
    inputs.forEach(function (input) {
      input.addEventListener(nameEvent, function () {
...
var filter = function filter(trigersSelector, contentsSelector, noneElementSelector, activeClass) {
  var trigers = document.querySelectorAll(trigersSelector),
      contents = document.querySelectorAll(contentsSelector),
      portfolioNo = document.querySelector(noneElementSelector);
  var timerPortfolioNo;
  ...
  function setActiveClass(triger) {
    trigers.forEach(function (child) {
  ...
  function filtersContentByTriger(triger) {
    ...
    contents.forEach(function (block) {
      if (checkClasesInblock(block)) {
        ...
        block.style.padding = '0rem'; // setTimeout(()=>{
    ...
    if (!someElemet) {
      ...
      timerPortfolioNo = setTimeout(function () {
    ...
    function checkClasesInblock(block) {
      ...
      try {
        for (var _iterator = triger.classList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var clas = _step.value;
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modal */ "./src/js/modul/modal.js");
  ...
  function bindForm(form) {
    var massegeStatus = {
      ...
      spinner: 'assets/img/spinner.gif'
        ...
        upload = document.querySelectorAll('[name="upload"]'); // form.user_phone.addEventListener('input', ()=>{
    ...
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_7__["postData"])(api, data).then(function (res) {
        console.log(res);
        ...
        setTimeout(function () {
          ...
          textStatus.remove();
          Object(_modal__WEBPACK_IMPORTED_MODULE_6__["closeAllModal"])();
        }, 5000); // form.user_phone.style.border = '';
      });
    });
  }
...
/***/ "./src/js/modul/modal.js":
/*!*******************************!*\
  !*** ./src/js/modul/modal.js ***!
  \*******************************/
/*! exports provided: default, closeAllModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeAllModal", function() { return closeAllModal; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
function showModal(Modal) {
  ...
  document.body.style.marginRight = "".concat(window.innerWidth - document.body.clientWidth, "px");
...
var modals = function modals() {
  function bindModal(selectorModal, selectorTriggers, selecttorClose) {
    ...
    var openByEndScroll = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    var requiredInputSeklector = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : false;
    var elModal = document.querySelector(selectorModal),
...
var scrolling = function scrolling() {
  var hashTrigers = document.querySelectorAll('[href^="#"]'),
      element = document.documentElement,
      scrollUp = document.querySelector('[href="#up"]');
  hashTrigers.forEach(function (triger) {
    triger.addEventListener('click', function (e) {
      ...
      var startScrollTop = Math.round(document.body.scrollTop || element.scrollTop);
      var hashElemTop = Math.round(document.querySelector(this.hash).getBoundingClientRect().top);
      ...
      function smoothScrollAnimation(time) {
        ...
        var lineProgress = (time - startDate) / duration;
        var progress = Math.pow(lineProgress, 3) + 3 * Math.pow(lineProgress, 2) * (1 - lineProgress); // const r  = Math.round(hashElemTop > 0 ? Math.min(startScrollTop + progress*speed, startScrollTop + hashElemTop) 
        //            : Math.max(startScrollTop - progress*speed, startScrollTop + hashElemTop));

        var r = Math.round(startScrollTop + hashElemTop * progress);
...
var showImg = function showImg() {
  var bloks = document.querySelectorAll('.sizes-block');
...
/* harmony default export */ __webpack_exports__["default"] = (showImg);

/***/ }),

/***/ "./src/js/modul/showMoreStiles.js":
/*!****************************************!*\
  !*** ./src/js/modul/showMoreStiles.js ***!
  \****************************************/
/*! exports provided: default */
...
var showMoreStiles = function showMoreStiles(trigerSelect) {
  ...
  /*#__PURE__*/
  function () {
    function Cart(srcImg, title, link, parentSelector) {
  ...
  var btn = document.querySelector(trigerSelect);
  btn.addEventListener('click', function () {
...
/* harmony default export */ __webpack_exports__["default"] = (showMoreStiles);

/***/ }),

/***/ "./src/js/modul/sliders.js":
/*!*********************************!*\
  !*** ./src/js/modul/sliders.js ***!
  \*********************************/
/*! exports provided: default */
...
function sliders(slidesSel, dir) {
  var prevSel = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  var nextSel = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  ...
  var timerSlider = setInterval(nextSlide, 3000);
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          ...
          throw "POST Erorr url:".concat(url, "  status:").concat(response.status);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("could not feth ".concat(url, ", status:").concat(res.status));
